          ...
          >
            <div className="space-y-6">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                technologies like React, Next.js, Node.js, and Python. I'm
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                always strive to improve my skills and deliver exceptional
                results.
              </p>
            </div>
            ...
            <div className="relative w-full h-96 glass-card overflow-hidden group">
              ...
              <div className="relative z-10 w-full h-full flex items-center justify-center text-white text-center p-8">
                <div>
                  ...
                  <p className="text-white/80">Crafting digital experiences</p>
                </div>
              </div>
